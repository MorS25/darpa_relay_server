...
public:
  ...
  cbor (cbor::map value);
	...
	const cbor::binary& to_binary () const;
	const cbor::string& to_string () const;
	const cbor::array& to_array () const;
	const cbor::map& to_map () const;
  ...
  operator char () const;
	...
	operator const cbor::binary& () const;
	operator const cbor::string& () const;
	operator const cbor::array& () const;
	operator const cbor::map& () const;
  ...
  static cbor decode (const std::string &in);
